...
## Version 1.20 (2026-07-02)

### [Download](https://github.com/Arthrimus/SVS_Firmware_Repository/releases/download/v1.20/SVS_Firmware_1.20.7z)
...
- Increased input deselect coast time from 2 seconds to 5 seconds. This helps prevent an input from deselecting during resolution change events where the sync signal may be interrupted for a period of time.
...
- Added new IR codes for future remote support.
