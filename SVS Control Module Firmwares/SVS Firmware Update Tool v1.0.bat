...
echo ************************************************************************************************************************
echo.
echo Checking current Firmware version. Done!
echo ------------------------------------------------------------------------------------------------------------------------
echo The current installed SVS Firmware version is %Build%.hex
echo ------------------------------------------------------------------------------------------------------------------------
echo.
...
if %errorlevel%==2 goto MANUAL
:EXEC
"tools\avrdude\7.2/bin/avrdude" -v -V -patmega328p -curclock -PCOM%num% -b115200 -D -xnometadata "-Uflash:w:%fn%:i"
pause